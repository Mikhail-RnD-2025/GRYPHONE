#!/usr/bin/env bash
# ============================================================
#  GRYPHONE — script 59: FIX DATABASE MODULE
#  ------------------------------------------------------------
#  What this script does:
#    1. Rewrites app/database.py with correct initialization
#    2. Removes problematic methods (_init_db, _get_conn, get_db)
#    3. Uses simple _create_tables() and _populate_from_json()
#    4. Ensures absolute paths for database location
#    5. Verifies app imports successfully
#
#  RUN:   bash update_scripts/59_fix_database_module.sh
# ============================================================
set -euo pipefail
...
# ============================================================
# Step 1: Rewrite app/database.py using Python (avoids heredoc issues)
# ============================================================
echo ""
echo "🔧 Rewriting app/database.py..."
...
if "${PYCMD[@]}" -c "from app import create_app; print('  ✔ App imports successfully')" 2>&1; then
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "✅ Database module fixed successfully"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
